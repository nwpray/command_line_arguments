...
int main(int argc, char* argv[]){
    ...
    //User enters too few parameters Program responds with Usage Page and returns 0
    if( argc < INDEX_FLAG + 1 ){
        UsagePage();
        return 0;
    }
    
    //User enters too many parameters Program responds with Usage Page and returns 1
    if (argc > INDEX_PORT + 1 ){
    ...
    if (((flag == FLAG_HELP) && argc > INDEX_FLAG + 1) || ((flag == FLAG_HELP_SHORT) && argc > INDEX_FLAG + 1)){
...
void UsagePage(){
    ...
    cout << "Usage: setport [FLAG]… [PORT]…" << endl;
    
    cout << "Examples:" << endl;
    cout << "\tsetport -p 1234\t\t#Sets port to listen to" << endl;
    cout << "\tsetport --port 123\t\t#Sets port to listen to" << endl;
    cout << "\tsetport -h\t\t\t#Displays this screen" << endl;
    cout << "\tsetport --help\t\t#Displays this screen" << endl;
